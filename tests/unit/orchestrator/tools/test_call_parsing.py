...
"""Unit tests for ``orchestrator.app.functions``.

The parsing fallbacks in this module exist because certain model endpoints
...
from orchestrator.app.tools.functions import (
    _coerce_value,
...
class TestCoerceValue:
    ...
    def test_literal_list_parsed_with_ast(self) -> None:
        # XML tool calls emit list args as their Python repr.
